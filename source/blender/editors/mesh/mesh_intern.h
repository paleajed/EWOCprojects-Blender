...
void MESH_OT_loop_presel(struct wmOperatorType *ot);
void MESH_OT_edgering_presel(struct wmOperatorType *ot);
...
void MESH_OT_shortest_path_presel(struct wmOperatorType *ot);
