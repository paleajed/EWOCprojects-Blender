...
#define ND_OB_PRESELECT		(9<<16)
#define ND_OB_VISIBLE		(10<<16)
#define ND_OB_RENDER		(11<<16)
#define ND_MODE				(12<<16)
#define ND_RENDER_RESULT	(13<<16)
#define ND_COMPO_RESULT		(14<<16)
#define ND_KEYINGSET		(15<<16)
#define ND_TOOLSETTINGS		(16<<16)
#define ND_LAYER			(17<<16)
#define ND_FRAME_RANGE		(18<<16)
#define ND_TRANSFORM_DONE	(19<<16)
